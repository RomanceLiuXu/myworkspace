...
public class CodeController {
	...
	public void getCode(HttpServletRequest request,HttpServletResponse response) throws IOException{
        ...
        //关闭流		
		out.close();
		System.out.println("生成的验证码为:"+ buffer.toString());
	}

	 @RequestMapping("/checkCode")
	 @ResponseBody
	  public Map<String,Object> checkCode(String vcode,HttpSession session){
	        Map<String, Object> map = new HashMap<>();
	        String verificationCode = (String) session.getAttribute("vcode");
	        System.out.println("前段传值:"+vcode);
	        System.out.println("session中获取:"+verificationCode);
	        if(verificationCode.equalsIgnoreCase(vcode)){
	            map.put("valid",true);
	        }else{
	            map.put("valid",false);
	        }
